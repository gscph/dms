...
namespace ResetIdSequenceMonthly
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                query.Criteria.AddCondition("gsc_resetsequenceno", ConditionOperator.Equal, "100000002");
            ...
            {
                string filename = "ResetIdSequenceMonthly";
