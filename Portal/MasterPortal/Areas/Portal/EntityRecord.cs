...
namespace Site.Areas.Portal
{
	...
	public class EntityRecord
    {
        ...
        {
            #region - DMS Custom Filter -

            var reference = entity.GetAttributeValue<string>("gsc_isvendorrecord");

            //add condition where, if business unit of current user equals MMPCDEV retain default values.
