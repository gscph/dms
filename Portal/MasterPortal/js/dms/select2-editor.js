...
(function (Handsontable) {
    ...
    Select2Editor.prototype.saveValue = function (val) {      
        // afterChange event needs 2D array. Ask them, not me.       

        this.instance.setDataAtRowProp(this.row, this.prop, val[0][0], 'edit');

       // Handsontable.hooks.run(this.instance, 'afterChange', changes, 'edit');
