    ...
    <div class="form-horizontal">
        <fieldset>
            ...
            <p class="login-box-msg">
                <%: Html.TextSnippet("Account/PasswordReset/ForgotPasswordFormHeading", defaultValue: "Forgot your password?", tagName: "span") %>
            </p>
            ...
            <button id="back" class="btn btn-default btn-flat" style="border: none; display: block; width: 100%;">Back</button>
        </fieldset>
    </div>
