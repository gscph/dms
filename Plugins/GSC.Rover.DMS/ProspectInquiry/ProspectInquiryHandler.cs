...
namespace GSC.Rover.DMS.BusinessLogic.ProspectInquiry
{
    public class ProspectInquiryHandler
    {
        ...
        public Entity DisqualifyProspectInquiry(Entity prospectInquiryEntity)
        {
            ...
            var DisqualifiedStatusReason = prospectInquiryEntity.GetAttributeValue<Int32>("gsc_disqualifiedstatusreason");
            if (DisqualifiedStatusReason == 0 || prospectInquiryEntity.GetAttributeValue<Boolean>("gsc_disqualified") == false)
            {
                return null;
            }
