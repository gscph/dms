...
namespace GSC.Rover.DMS.BusinessLogic.AllocatedVehicle
{
    public class AllocatedVehicleHandler
    {
        ...
        //Created By: Leslie Baliguat, Created On: 5/25/2017
        /*Purpose: Cannot remove allocated vehicle once subject for PDI
         * Registration Details: 
         * Event/Message: 
         *      PreValidate/Delete: 
         * Primary Entity: Allocated Vehicle
         */
        public Boolean IsSubjectforPDI(Entity allocatedEntity)
        {
