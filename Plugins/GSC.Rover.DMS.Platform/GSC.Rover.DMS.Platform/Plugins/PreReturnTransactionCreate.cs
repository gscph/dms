// <copyright file="PreReturnTransactionCreate.cs" company="">
// Copyright (c) 2017 All Rights Reserved
// </copyright>
// <author></author>
// <date>2/8/2017 10:25:58 AM</date>
// <summary>Implements the PreReturnTransactionCreate Plugin.</summary>
// <auto-generated>
...
namespace GSC.Rover.DMS.Platform.Plugins
{
    ...
    public class PreReturnTransactionCreate : Plugin
    {
        ...
        /// </summary>
        public PreReturnTransactionCreate()
            : base(typeof(PreReturnTransactionCreate))
        {
            base.RegisteredEvents.Add(new Tuple<int, string, string, Action<LocalPluginContext>>(20, "Create", "gsc_cmn_returntransaction", new Action<LocalPluginContext>(ExecutePreReturnTransactionCreate)));
