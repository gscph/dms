...
$(document).ready(function () {
    ...
    if (webRole == 'Cashier' || webRole == "Vehicle Allocator" || webRole == "CC Manager") {
    ...
    if (status == 'For Allocation' && webRole != 'Cashier' && webRole != "Vehicle Allocator" && webRole != "CC Manager") {
    ...
    if (status != 'Cancelled' && webRole != 'Cashier' && webRole != "Vehicle Allocator" && webRole != "Invoicer" && webRole != "CC Manager") {
