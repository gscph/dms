...
$(document).ready(function () {
    ...
    if (webRole == 'Cashier' || webRole == "Vehicle Allocator" || webRole == "C & C Manager") {
    ...
    if (status == 'For Allocation' && webRole != 'Cashier' && webRole != "Vehicle Allocator" && webRole != "C & C Manager") {
    ...
    if (status != 'Cancelled' && webRole != 'Cashier' && webRole != "Vehicle Allocator" && webRole != "Invoicer" && webRole != "C & C Manager") {
